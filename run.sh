...
# Determine the actual user behind sudo
...
DNF_PACKAGES=(
    ...
    fwupd-plugin-uefi-capsule-data sddm xorg-x11-server-Xwayland switcheroo-control
    ...
    pipewire-gstreamer pipewire-jack-audio-connection-kit pipewire-jack-audio-connection-kit-libs 
    ...
    btrfs-progs gimp deja-dup papirus-icon-theme snapd "materia*"
)
...
echo "--- Setup Complete! Please reboot to finalize everything. ---"#!/bin/bash
